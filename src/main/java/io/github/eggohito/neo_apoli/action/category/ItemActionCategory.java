...
public class ItemActionCategory extends ActionCategory<ItemAction> {
	...
	private static final Function<String, CommandBuilder> BUILDER_FACTORY = actionKey -> new CommandBuilder() {
		...
		public int execute(ServerCommandSource commandSource, ContextAware.ErrorReporter reporter, ItemAction itemAction, List<Context> contexts) throws CommandSyntaxException {
